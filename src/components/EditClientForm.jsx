...
export default function EditClientForm({ client, onClientUpdated, onCancel }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setUpdating(true)
    try {
      await onClientUpdated(client.id, formData)
    } catch (error) {
        ...
        <div className="max-h-[75vh] overflow-y-auto rounded-[30px] bg-white/95 p-8">
          <div className="mb-6 flex items-start justify-between">
            <div>
              ...
              <h2 className="text-2xl font-semibold text-gray-900">Modificar datos del cliente</h2>
